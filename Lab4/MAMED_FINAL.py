...
def Left_backward(LX):
	if LX == 3: 
		...
		backwardsL(int(2)/1000.0, int(50))
...
def Right_forward(RX):
	...
	#In between cases
		...
		forwardR(int(2)/1000.0, int(220))
	elif RX == 1.5: 
		forwardR(int(2)/1000.0, int(150))
	elif RX == 1.2: 
		forwardR(int(2)/1000.0, int(120))
	elif RX == 0.5:
		forwardR(int(2)/1000.0, int(50))
	elif RX == 0.2: 
		forwardR(int(2)/1000.0, int(20))
...
def Right_backward(RX):
	...
	#In between cases
		...
		backwardsR(int(2)/1000.0, int(220))
	elif RX == 1.5: 
		...
		backwardsR(int(2)/1000.0, int(20))
